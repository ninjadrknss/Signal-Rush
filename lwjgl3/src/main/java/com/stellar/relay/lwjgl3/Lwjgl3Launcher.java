package com.stellar.relay.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import com.stellar.relay.Main;
...
public class Lwjgl3Launcher {
	...
	private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
		...
		configuration.setTitle("Stellar Relay");
		...
		// You would need to add this line to lwjgl3/build.gradle , below the dependency on
		// `gdx-backend-lwjgl3`:
		...
		//
		//		configuration.setOpenGLEmulation(Lwjgl3ApplicationConfiguration.GLEmulation.ANGLE_GLES20, 0,
		// 0);
